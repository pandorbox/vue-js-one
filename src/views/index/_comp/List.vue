      ...
      <div class="item" v-for="(item1,indexs) in tit" :key="indexs">
          ...
          <div class="item-msg">
              ...
              <div class="item-lists">
                  <div class="item-list" v-for="(item,index) in items[indexs]" @click="routerTo(indexs,index)" :key="item.img">
  ...
  methods: {
    routerTo(indexs,index) {
      ...
      this.$router.push({
        name: `study`,
        params: {
          id: this.items[indexs][index].id,tit:this.items[indexs][index].kcname
        }
      })
    }
  }
